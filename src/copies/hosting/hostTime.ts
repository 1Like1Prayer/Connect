export const hostTimeCopy = {
  ...
  thisTimeDoesNotExistInBecauseTheClocks: (timeZone: string | number) => "This time does not exist in " + String(timeZone) + " because the clocks move forward. Choose another time.",
